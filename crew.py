...
def create_research_tasks():
    ...
    t3 = Task(
        description=(
            ...
            "TARGET LENGTH: 900 to 1,200 words. Write concisely and high-signal, avoiding fluff or sprawling tables.\n\n"
            "The report MUST include ALL of the following 7 sections in order, adhering to these structural rules:\n"
            "1. Title and Executive Summary (concise synthesis of findings and core metrics, ~150 words).\n"
            "2. Market Overview & Current Trends (narrative overview plus 1 compact table of 4-5 key metrics, ~200 words).\n"
            "3. Key Benefits & Strategic Advantages (3-4 concise bullet points, ~150 words).\n"
            "4. Implementation Challenges & Risk Factors (3-4 concise bullet points, ~150 words).\n"
            "5. Real-World Case Studies / Industry Examples (STRICTLY limit to TOP 2 concise case studies as bullet points, 2-3 sentences each. DO NOT use a table for case studies, ~150 words).\n"
            "6. Future Outlook & Strategic Recommendations (STRICTLY top 3-4 actionable recommendations without nested subsections 6.1/6.2 or extra tables, ~150 words).\n"
            "7. References / Sources Section (STRICTLY formatted as a clean bulleted list of 3-5 cited URLs in the format: '- **[Source Name]**: URL'. DO NOT use a Markdown table for references).\n\n"
            "CRITICAL COMPLETION REQUIREMENT:\n"
            "- Budget your words so that every section completes cleanly with plenty of headroom.\n"
            "- Sections 6 (Future Outlook) and 7 (References) are MANDATORY and must never be cut off, abbreviated, or omitted.\n\n"
        ...
        expected_output=(
            "A complete, fully finished Markdown executive research report (approx. 900-1,200 words) containing all 7 numbered sections "
            "where Case Studies are 2 concise bullets, Recommendations are 3-4 actionable bullets, and References is a clean bulleted list of 3-5 source URLs."
        ),
        agent=writer,
        context=[t2],
    )
